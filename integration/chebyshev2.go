...
type ChebyshevType2 struct {
}

func (ct2 ChebyshevType2) check(n int, params *fixedParams) err.GSLError {
...
func (ct2 ChebyshevType2) init(n int, diag, subdiag []float64, params *fixedParams) err.GSLError {
